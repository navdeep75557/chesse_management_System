...
<div class="mb-6">
	...
	<h1 class="font-display text-2xl font-bold text-slate-900 mt-1">{data.player.name}'s Match History</h1>
				...
				{#each data.matches as match (match.id)}
					<tr class="border-b border-slate-100 last:border-0 hover:bg-indigo-50/40 transition-colors">
						<td class="px-4 py-3 text-slate-900">
							<a href="/tournaments/{match.tournament.id}" class="hover:text-indigo-600"
